    ...
    private function data(): array
    {
        ...
        return [
            [
                ...
                'zh' => ['title' => 'InnoCMS v1.0 正式发布：为 B2B 独立站而生的轻量级系统', 'summary' => '模块化 innopacks 架构、Hook 插件系统、主题一键切换、内置商品与多语言——InnoCMS v1.0 让品牌独立站从安装到上线只需几分钟。', 'content' => '<p>InnoCMS v1.0 正式发布。它是一款轻量级 B2B 独立站系统，基于 Laravel 构建，内置商品管理，面向外贸品牌独立站场景。</p><h3>核心特性</h3><ul><li><strong>模块化架构</strong>：innopacks 将 common / panel / front / install / plugin 拆分为独立包，清晰可维护</li><li><strong>Hook 插件系统</strong>：通过 <code>listen_hook_action</code> / <code>listen_blade_insert</code> 等函数零侵入扩展</li><li><strong>主题系统</strong>：默认官方主题 + 行业垂直主题，后台一键切换</li><li><strong>内置商品</strong>：商品、分类与询盘管理，开箱即用承载 B2B 业务</li><li><strong>内置多语言</strong>：内容级中英双语，URL 自动带语言前缀</li></ul><p>从安装到上线只需几分钟，帮助团队把精力放在内容与业务本身，而不是建站的技术细节。</p>'],
                'en' => ['title' => 'InnoCMS v1.0 Released: A Lightweight System Built for B2B Standalone Sites', 'summary' => 'Modular innopacks architecture, a hook-based plugin system, one-click themes and built-in products & multilingual content — go from install to launch in minutes.', 'content' => '<p>InnoCMS v1.0 is officially released. It is a lightweight B2B standalone website system on Laravel, with built-in product management, targeting foreign trade brand independent sites.</p><h3>Highlights</h3><ul><li><strong>Modular architecture</strong>: innopacks splits common / panel / front / install / plugin into independent packages</li><li><strong>Hook-based plugins</strong>: extend anything with <code>listen_hook_action</code> / <code>listen_blade_insert</code> and friends</li><li><strong>Theme system</strong>: an official default theme plus vertical industry themes, switchable in the admin</li><li><strong>Built-in products</strong>: product, category and inquiry management ready out of the box for B2B business</li><li><strong>Built-in multilingual</strong>: content-level zh/en with locale-aware URLs</li></ul><p>From install to launch in minutes, so your team focuses on content and business instead of plumbing.</p>'],
            ],
            [
