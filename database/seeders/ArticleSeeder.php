...
class ArticleSeeder extends BaseSeeder
{
     ...
     * Article images use stable Lorem Picsum seeds (no bundled binaries).
     *
     * @return array[]
     */
    private function data(): array
    {
        $pic = static fn (string $seed): string => 'https://picsum.photos/seed/innocms-'.$seed.'/800/450';

        return [
            [
                'id' => 1, 'catalog_id' => 4, 'slug' => 'innocms-v1-released', 'image' => $pic('v1'), 'viewed' => 612, 'tags' => [2, 1],
            ...
            [
                'id' => 2, 'catalog_id' => 2, 'slug' => 'plugin-development-quickstart', 'image' => $pic('plugin'), 'viewed' => 438, 'tags' => [3, 1],
            ...
            [
                'id' => 3, 'catalog_id' => 2, 'slug' => 'theme-development-guide', 'image' => $pic('theme'), 'viewed' => 356, 'tags' => [4, 1],
            ...
            [
                'id' => 4, 'catalog_id' => 2, 'slug' => 'multilingual-content-setup', 'image' => $pic('i18n'), 'viewed' => 289, 'tags' => [5, 1],
            ...
            [
                'id' => 5, 'catalog_id' => 3, 'slug' => 'saas-managed-hosting', 'image' => $pic('saas'), 'viewed' => 374, 'tags' => [2],
            ...
            [
                'id' => 6, 'catalog_id' => 3, 'slug' => 'innocms-partner-ecosystem', 'image' => $pic('partner'), 'viewed' => 245, 'tags' => [1],
            ...
            [
                'id' => 7, 'catalog_id' => 5, 'slug' => 'solution-b2b-export-site', 'image' => $pic('sol-b2b'), 'viewed' => 318, 'tags' => [6, 2],
            ...
            [
                'id' => 8, 'catalog_id' => 5, 'slug' => 'solution-brand-corporate-site', 'image' => $pic('sol-brand'), 'viewed' => 271, 'tags' => [6, 4],
