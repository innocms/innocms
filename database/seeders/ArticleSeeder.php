...
class ArticleSeeder extends BaseSeeder
{
    ...
    private function data(): array
    {
        ...
        return [
            [
                'id' => 1, 'catalog_id' => 4, 'slug' => 'innocms-v1-released', 'image' => $pic('innocms-v1-released'), 'viewed' => 612, 'tags' => [2, 1],
            ...
            [
                'id' => 7, 'catalog_id' => 5, 'slug' => 'solution-b2b-export-site', 'image' => $pic('b2b-export-site'), 'viewed' => 318, 'tags' => [6, 2],
            ...
            [
                'id' => 8, 'catalog_id' => 5, 'slug' => 'solution-brand-corporate-site', 'image' => $pic('brand-corporate-site'), 'viewed' => 271, 'tags' => [6, 4],
