# InnoCMS DevTools Module Tests

This directory contains test cases for the InnoCMS DevTools module, which provides development utilities and scaffolding tools.
...
1. All tests extend from InnoCMS\DevTools\Tests\TestCase
