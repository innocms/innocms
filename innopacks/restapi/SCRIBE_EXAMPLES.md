# Scribe Annotation Examples for InnoCMS Controllers

This document provides examples of how to add Scribe PHP 8.1 Attribute annotations to InnoCMS controllers.
