...
<div class="tab-pane fade show active" id="ai-tools" role="tabpanel" aria-labelledby="ai-tools-tab">
  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-lg-6">
          <x-panel-form-select title="{{ __('aicore::setting_ai.text_generation_provider') }}" name="ai_text_provider"
                              :options="$ai_models ?? []" key="code" label="name"
                              value="{{ old('ai_text_provider', system_setting('ai_text_provider') ?: system_setting('ai_model')) }}" />
        </div>
        <div class="col-lg-6">
          <x-panel-form-input title="{{ __('aicore::setting_ai.text_model_override') }}"
                             name="ai_text_model"
      ...
      <div class="row mt-3">
        <div class="col-lg-6">
          <x-panel-form-select title="{{ __('aicore::setting_ai.image_generation_provider') }}" name="ai_image_provider"
                              :options="$ai_models ?? []" key="code" label="name"
                              value="{{ old('ai_image_provider', system_setting('ai_image_provider')) }}" />
        </div>
        <div class="col-lg-6">
          <x-panel-form-input title="{{ __('aicore::setting_ai.image_model_override') }}"
                             name="ai_image_model"
...
<script>
// Provider Management
const aiPresets = {!! json_encode(($ai_presets ?? []) ?: app(\InnoCMS\Aicore\Services\ProviderRegistry::class)->getPresets()) !!};
