...
<x-panel::form.right-btns formid="category-form" />

@section('content')
  <form class="needs-validation" novalidate id="category-form"
        ...
        <div class="card mb-3">
          <div class="card-body">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="content-tab" data-bs-toggle="tab" data-bs-target="#content-tab-pane"
                  ...
                  aria-selected="false">{{ __('panel/category.content_tab') }}</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="extra-tab" data-bs-toggle="tab" data-bs-target="#extra-tab-pane"
                  ...
                  aria-selected="false">{{ __('panel/category.extra_tab') }}</button>
              </li>
              <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="myTabContent">
              @include('panel::categories.panes.tab_pane_basic')
              @include('panel::categories.panes.tab_pane_content')
              @include('panel::categories.panes.tab_pane_extra')
              @include('panel::categories.panes.tab_pane_seo')
