...
<head>
  ...
  <title>@yield('title', '') - InnoCMS</title>
  <meta name="keywords" content="@yield('keywords', 'InnoCMS, 创新, 开源, CMS, Laravel 11, 多语言, 多货币, Hook, 插件架构, 灵活, 强大')">
  <meta name="generator" content="InnoCMS {{ innocms_version() }}">
