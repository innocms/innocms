...
@section('title', __('common/base.server_error') . ' - ' . config('app.name'))
...
@section('content')
  <div class="container py-5">
    <div class="row align-items-center justify-content-center" style="min-height: calc(100vh - 400px);">
      <div class="col-md-6 text-center">
        <div class="mb-4">
          <div class="error-code" style="font-size: 120px; line-height: 1; color: var(--bs-danger, #dc3545); font-weight: 300;">
            500
          </div>
        ...
        <div class="d-flex gap-3 justify-content-center">
          <a href="javascript:;" onclick="location.reload();" class="btn btn-outline-secondary">
            <i class="bi bi-arrow-clockwise me-1"></i> {{ __('common/base.refresh') }}
          </a>
          <a href="{{ front_route('home.index') }}" class="btn btn-primary">
            <i class="bi bi-house me-1"></i> {{ __('common/base.home') }}
          </a>
        </div>
      </div>
    </div>
  ...
  <style>
    .error-code {
      text-shadow: 4px 4px 10px rgba(220, 53, 69, 0.1);
      position: relative;
    }
