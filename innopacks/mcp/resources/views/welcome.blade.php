...
$categories = [
    ...
    'config' => ['label' => __('mcp::welcome.cat_config'), 'prefix' => ['locale_', 'file_']],
];
...
<body>
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      <a href="#overview">&#9679; {{ __('mcp::welcome.nav_overview') }}</a>
      <a href="#architecture">&#9883; {{ __('mcp::welcome.nav_architecture') }}</a>
      <a href="#connect">&#9889; {{ __('mcp::welcome.nav_connect') }}</a>
      <a href="#auth">&#128274; {{ __('mcp::welcome.nav_auth') }}</a>
      <a href="#tools">&#128736; {{ __('mcp::welcome.nav_tools') }} <span class="count">{{ count($tools) }}</span></a>
    </nav>
      ...
      <div class="card">
        ...
        <div class="arch-diagram">
          ...
          <div class="arch-box">
            ...
            <code style="font-size:.75rem;">InnoCmsMcpServer</code><br>
    ...
    <section id="connect">
      ...
      <div class="card" id="card-claude">
        ...
        <div style="position:relative;">
          <pre><code id="cmd-claude">claude mcp add --transport http innocms {{ $mcpUrl }} \
  --header "Authorization: Bearer <span class="token-val">YOUR_TOKEN</span>"</code></pre>
          <button class="copy-btn" data-target="cmd-claude" title="Copy" style="position:absolute;top:8px;right:8px;">&#128203;</button>
        </div>
      </div>
    ...
    "innocms": {
      ...
      "headers": {
        "Authorization": "Bearer <span class="token-val">YOUR_TOKEN</span>"
          ...
          <button class="copy-btn" data-target="cmd-json" title="Copy" style="position:absolute;top:8px;right:8px;">&#128203;</button>
        </div>
      </div>

      <div class="card" id="card-notoken" style="display:none;background:#fef3c7;border-color:#f59e0b;">
        <p style="margin:0;font-size:.9rem;">&#9888; {{ __('mcp::welcome.no_token') }}</p>
      </div>
    </section>
      ...
      <div class="card" style="padding:0;overflow:hidden;margin-bottom:12px;">
        ...
        <table>
          <tbody>
            ...
            <tr>
              <td style="width:200px;"><code>{{ $tool->name() }}</code></td>
