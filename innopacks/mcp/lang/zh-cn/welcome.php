...
return [
    'title'             => 'MCP 服务',
    'subtitle'          => ':name 通过 MCP 协议向外部 AI Agent 暴露站点内容查询与管理能力。',
    'active'            => '运行中',
    ...
    'nav_tools'         => '所有工具',
    'overview_title'    => '概述',
    'overview_desc'     => '此端点实现 <strong>Model Context Protocol</strong>（Streamable HTTP，JSON-RPC 2.0）。Claude Code、Cursor、Cline 等 AI 工具可通过管理员认证安全地查询和管理站点内容。所有工具均继承后台权限体系，写操作需额外授权。',
    'endpoint_label'    => '端点地址：',
    ...
    'arch_note_badge'   => '提示',
    'arch_note'         => '后台面板内的 AI 对话（innopacks/aicore）基于同一套 Tool 体系，通过 Web UI 直接交互，无需 MCP 协议。',
    'connect_title'     => '接入指南',
    'your_token'        => '你的管理员令牌',
